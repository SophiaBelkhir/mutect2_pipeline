...
nextflow run ${PIPELINE_DIR}/stage3.nf \
         ...
         --normals ${ANALYSIS_DIR}/021225_realigned_highcov/cram_files_for_stage_3/normals \
         --tumours ${ANALYSIS_DIR}/021225_realigned_highcov/cram_files_for_stage_3/tumours \
         --samplesheet ${ANALYSIS_DIR}/021225_realigned_highcov/cram_files_for_stage_3/samplesheet.csv \
         --germline_resource ${ANALYSIS_DIR}/03_04_26_mutect2_stage2_test/MergedResources/germline_resource.vcf.gz \
         ...
         -resume \
         -config ${ANALYSIS_DIR}/stage3_nextflow.config
